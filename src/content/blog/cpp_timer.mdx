...
![win60fps](../../assets/posts/timer/win_with_timebeginperiod/16.666667ms.svg)

MultiMedia Timer, TimerQueue Timer, ThreadPool Timerは単位指定が$\SI{1}{ms}$なので周期が$\SI{16}{ms}$でちょっと短くなっている.

- Linux

![linux60fps](../../assets/posts/timer/linux/16.666667ms.svg)

- macOS

![mac60fps](../../assets/posts/timer/mac/16.666667ms.svg)
...
![win60fps](../../assets/posts/timer/win_with_timebeginperiod/1.0ms.svg)

ThreadPool Timerは$\SI{16}{ms}$未満を指定しても意味がないらしい. なお, TimerQueue TimerもThreadPool Timerに隠れて見えていないが同様である.

- Linux

![linux60fps](../../assets/posts/timer/linux/1.0ms.svg)

- macOS

![mac60fps](../../assets/posts/timer/mac/1.0ms.svg)
...
![win60fps](../../assets/posts/timer/win_with_timebeginperiod/500.0us.svg)

Waitable Timerはこのあたりまで対応できる.

- Linux

![linux60fps](../../assets/posts/timer/linux/500.0us.svg)

- macOS

![mac60fps](../../assets/posts/timer/mac/500.0us.svg)
...
![win60fps](../../assets/posts/timer/win_with_timebeginperiod/100.0us.svg)
...
![linux60fps](../../assets/posts/timer/linux/100.0us.svg)

- macOS

![mac60fps](../../assets/posts/timer/mac/100.0us.svg)
...
![win60fps](../../assets/posts/timer/win_with_timebeginperiod/1.0us.svg)

PerformanceCounterとSoftware Sleepの組み合わせはかなり頑張ってるが, 途中ちょっとおかしくなる.

- Linux

![linux60fps](../../assets/posts/timer/linux/1.0us.svg)

- macOS

![mac60fps](../../assets/posts/timer/mac/1.0us.svg)
...
![win60fps](../../assets/posts/timer/win_without_timebeginperiod/16.666667ms.svg)

- $\SI{1}{ms}$

![win60fps](../../assets/posts/timer/win_without_timebeginperiod/1.0ms.svg)

- $\SI{500}{us}$

![win60fps](../../assets/posts/timer/win_without_timebeginperiod/500.0us.svg)
